              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <th colSpan={variants.length} className="variant-header">
                      <div className="variant-scroll-container"> {/* Added Scroll Container */}
                        {variants.map((variant, index) => (
                          <div key={variant.id} className="variant-header-cell">
                          ...
                          >
                            {(provided) => (
                              <tr
                                ...
                                {...provided.dragHandleProps} // Make entire row draggable
                              ...
                              {state.variants.map((variant) => (
                                <td
                                  key={variant.id}
                                  className=".table-data header-cell"
                                >
                                  {variant.image ? (
