...
FilterModal.propTypes = {
  ...
  filters: PropTypes.arrayOf( // filters must be an array of objects
    PropTypes.shape({
      id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
      value: PropTypes.string.isRequired
    })
  ).isRequired,
  handleFilterChange: PropTypes.func.isRequired, // handleFilterChange must be a function
  handleAddFilter: PropTypes.func.isRequired, // handleAddFilter must be a function
  handleRemoveFilter: PropTypes.func.isRequired, // handleRemoveFilter must be a function
  handleSaveFilters: PropTypes.func.isRequired, // handleSaveFilters must be a function
};
